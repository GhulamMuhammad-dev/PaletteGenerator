...
import { Palette, RefreshCw, Settings, HelpCircle, Moon, Sun, Brain } from 'lucide-react';
...
export const PaletteGenerator: React.FC = () => {
  ...
  const tabs = [
    { id: 'generator', label: 'Generator', icon: <Palette className="w-4 h-4" /> },
    { id: 'ai', label: 'AI Assistant', icon: <Brain className="w-4 h-4" /> },
    { id: 'accessibility', label: 'Accessibility', icon: <HelpCircle className="w-4 h-4" /> },
    { id: 'preview', label: 'Preview', icon: <Settings className="w-4 h-4" /> },
    { id: 'export', label: 'Export', icon: <RefreshCw className="w-4 h-4" /> }
  ] as const;
  ...
  return (
    <div className={`min-h-screen ${bgPrimary} transition-colors duration-300`}>
      {/* Header */}
      <header className={`${bgSecondary} border-b ${borderColor} sticky top-0 z-10 transition-colors duration-300`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg" />
              <h1 className={`text-xl font-bold ${textPrimary}`}>Color Palette Studio</h1>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              {!brandStrategy && (
                ...
                >
                  ...
                  <span className="hidden sm:inline">Setup AI Assistant</span>
                </button>
              )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="relative">
              ...
              >
                <RefreshCw className="w-4 h-4 transform rotate-45" />
              </button>
              <BrandStrategyForm 
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {activeTab === 'generator' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              {/* Color Picker */}
              <div className={`${bgSecondary} rounded-lg border ${borderColor} p-6 transition-colors duration-300`}>
                <ColorPicker
                  color={baseColor}
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2">
                            ...
                            <div className="relative group/tooltip">
                              ...
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-64 p-2 bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg opacity-0 group-hover/tooltip:opacity-100 transition-opacity z-10">
                                {type.description}
                              </div>
                            </div>
                          </div>
            ...
            <div className="lg:col-span-2">
              <div className={`${bgSecondary} rounded-lg border ${borderColor} p-6 transition-colors duration-300`}>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={regeneratePalette}
                    className={`p-2 ${textSecondary} hover:text-gray-800 dark:hover:text-gray-200 ${hoverBg} rounded-lg transition-colors`}
        ...
        {activeTab === 'export' && (
          <ExportTools palette={palette} colors={colors} />
        )}
      </main>
    </div>
  );
